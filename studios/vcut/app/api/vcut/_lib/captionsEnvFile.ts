...
/** Same per-studio env file `_lib/inpaintEnvFile.ts` already uses (`Documents/Veasna OS/vcut.env`
 *  in the packaged app via `VEASNA_WORKSPACE_ROOT`, a gitignored `.env.vcut` in this checkout under
