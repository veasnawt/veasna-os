...
// Explicit rather than relying on Next's own default: VCut's responsive layout (see
// VCutApp.tsx) assumes the browser reports the device's real width, not a desktop-sized virtual
